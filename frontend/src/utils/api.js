...
export const getDetailedAnalytics = ()         => API.get('/users/detailed-analytics');
...
// ── AI — Scheduling ───────────────────────────────────────────────────────────
export const scheduleAIQuiz        = (data) => API.post('/ai/schedule-quiz', data);
export const getScheduledQuizzes   = ()     => API.get('/ai/scheduled-quizzes');
export const updateScheduledQuiz   = (id, data) => API.put(`/ai/scheduled-quizzes/${id}`, data);
export const deleteScheduledQuiz   = (id)   => API.delete(`/ai/scheduled-quizzes/${id}`);
...
export const generateAICodingChallenges = (data) => API.post('/coding/ai-generate', data);
